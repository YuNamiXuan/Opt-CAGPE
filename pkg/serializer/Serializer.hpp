/**
 * Serializer.hpp: A class for file I/O operations, mainly used for handling read
 *                 and write operations of large blocks of data.
 */
#pragma once
...
public:
    ...
    template <class T>
    int read_block(int block_id, T *block_ptr);
